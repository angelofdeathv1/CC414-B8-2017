<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/main/main.Master" AutoEventWireup="true" CodeBehind="reporter-admin.aspx.cs" Inherits="ReportsGeneratorPlugin.PL.reporter_admin" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentFooter" runat="server">
    ...
    <script src="js/jqgrid-reporter-admin.js?v=1"></script>
    <script>
