function getJQGridDetail() {
    sParameters = '';
    ExecReporterURLExt(JSON_JQGRID_STRUCT_JSONP_URI + '&sNewSearch=true&bUserData=0', 132, sParameters, 50, 1, setCustomFormatJQGrid);
}
...
function GetGrid0_URL() {
    var sParameters = '';
    return getReporterURL(JSON_JQDATAGRID_URI, 132, sParameters, 0, 0) + '&sNewSearch=false';
}

function GetGrid0_Export_URL() {
    var sParameters = '';
    return getReporterURL(JSON_EXPORT_URI, 132, sParameters, 0, 1);
}
