...
function GetGrid0_URL() {
    ...
    return "Controller.aspx?sAction=getDataGrid&nReportID=" + $('#hfReportID').val() + "&sReportUUID=" + $('#hfReportUUID').val() + "&sParameters=" + $('#hfParameters').val() + sRows + "&sNewSearch=" + $('#hfNewSearch').val();
}
...
function excelExport() {
    var sParameters = "&nReportID=" + $('#hfReportID').val() + "&sParameters=" + $('#hfParameters').val() + "&sNewSearch=" + $('#hfNewSearch').val() + "&nHeight=" + $('#hfHeight').val();
