...
namespace ReportsGeneratorPlugin
{
    public partial class Controller : Code.PageBase
    {
        ...
        public void getRawDataPivot()
        {
            ...
            string sColumnX = Request["sX"];
            string sColumnY = Request["sY"];
            string sColumnZ = Request["sZ"];

            DataTable oPivotTable = PivotTable.GetInversedDataTable(oDataTable, sColumnX, sColumnY, sColumnZ, "", true);
            Result oDataResult = new Result { result = "OK", data = oDataTable };

            ResponseJsonNewton(oDataResult);
        }
    }
}